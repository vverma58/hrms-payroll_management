                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">Comp-Off  Request  ${actionStatus}</span></td>
                                    </tr>
                                    </tbody>
                                </table>
                                <p><br/><br/></p>
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <h1 class="tw-h1"
                                                ...
                                                Hello ${employeeName},</h1>
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                            <span style="font-weight: 400;">Your comp-off request has been ${actionStatus}. Below are the comp-off request details.</span>
                                            <br></br><span style="font-weight: 400;">Action: <strong>${action}</strong></span>
                                            <br></br><span
                                                style="font-weight: 400;">CompOffStatus: <strong>${actionStatus}</strong></span>
                                             <p class=""
                                                                    style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
