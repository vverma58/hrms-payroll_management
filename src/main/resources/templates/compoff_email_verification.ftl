                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tw-card-header"
                                                                ...
                                                                align="center"><span style="font-weight: 600;">Email
                                                                   Compensation Confirmation Required</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="tw-card-body"
                                                                ...
                                                                <p class=""
                                                                    ...
                                                                    <label for="Employee_Id">Employee_Id</label>:-<a id = "Employee_Id" >${EmpId}</a><br>
                                                                   <label for="Name">Name</label>:-<a  id = "Name">${Name}</a><br>
                                                                  </p>                                                                        
                                                                </span><br /><span
                                                                        style="font-weight: 400;">Confirm this Email To update the above details of the given user in the Database </span>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="button__td "
                                                                                                style="border-radius: 7px; text-align: center; width: 523px;"> <a
                                                                                                    ...
                                                                                                    href="${compOffApprovalLink}"
                                                                                                    target="_blank"
                                                                                                    rel="noopener">Approved</a>
                                                                                                </td>
																							

                                                                                        
																						<td class="butto"
                                                                                                style="border-radius: 7px; text-align: center; width: 523px; background-color:red">
																								<a
                                                                                                    class="button__a"
                                                                                                    ...
                                                                                                    href="${compOffRejectionLink}"
                                                                                                    target="_blank"
                                                                                                    rel="noopener">Rejected</a>
                                                                                                </td>
                                                                                    </tr>
																					</tbody>
